...
function TextBlock({ title, content, className = "" }: { title: string; content: string; className?: string }) {
...
function ListBlock({ title, items, className = "" }: { title: string; items: string[]; className?: string }) {
